<?php
  ...
  */
  class FileUpload {
    ...
    private $allowtype = array('jpg','gif','png','pdf','zip','mp4','txt'); //设置限制上传文件的类型
    private $maxsize = 1024*1024*10000;           //限制文件上传大小（字节）
    ...
    private function getError() {
      $str = "[<font style='color:red'>错误</font>]: 上传文件[<font style='color:red'>{$this->originName}</font>]时出错 : ";
